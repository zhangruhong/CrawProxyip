...
public class CheckJiPiaoStat implements Job, Runnable {
    
    public CheckJiPiaoStat() {
    }
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            if (rs.next()) {
                // SendInfo.sentMessage("1381266", "机票比价"
                // + DateUtilZuode.getDateTimeString("hh") + "时的抓取量是"
                // + rs.getString("s"));
                
                // SendInfo.sentMessage("18020280367,13812663314", "机票比价" +
                // DateUtilZuode.getDateTimeString("hh") + "时的抓取量是" +
                // rs.getString("s"));
                LyUtil.sendMessage("18020280367,13812663314", "机票比价" + DateUtilZuode.getDateTimeString("hh") + "时的抓取量是" + rs.getString("s"));
            }
        } catch (Exception e) {
    ...
    public void task() throws SchedulerException {
        ...
        JobDetail jobDetail = new JobDetail("jobDetail", "jobDetailGroup", CheckJiPiaoStat.class);
        ...
        try {
            ...
            // 0 04 12-16 ? * *
            // 0 33 16 * * ?
            CronExpression cexp = new CronExpression("0 0 12-13 * * ?");
